<nav x-data="{ open: false }" class="bg-green-400">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center text-green-700">
                    <a href="{{url('/') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <div class="flex items-center text-black">
                        <a href="{{url('/api/recipes/1')}}" target="_blank"
                            class="rounded-md px-3 py-2   transition hover:text-black/70 focus:outline-none">
                            API_recipes
                        </a>
                        <a href="{{url('/api/recipe/1')}}" target="_blank"
                            class="rounded-md px-3 py-2 text-black  transition hover:text-black/70 focus:outline-none">
                            API_recipe
                        </a>
                        <a href="{{url('/api/category/1/1')}}" target="_blank"
                            class="rounded-md px-3 py-2 text-black  transition hover:text-black/70 focus:outline-none">
                            API_category
                        </a>
                    </div>
            ...
            <div class="flex items-center">
                <p class="mr-6 text-green-700">Bienvenido/a, {{ auth()->user()->name }}!</p>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <!-- Authentication -->
                    <a href="{{ route('logout') }}" class="text-red-700 font-bold hover:underline hover:text-red-500"
